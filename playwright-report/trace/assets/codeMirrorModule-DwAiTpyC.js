            ...
            return function (u, h) {
              ...
              for (var Ke = 0; Ke < k; ++Ke) {
                ...
                if (st == ",") x[Ke] = "N";
                  ...
                  for (
                    var Mt = (Ke && x[Ke - 1] == "!") || (Xe < k && x[Xe] == "1") ? "1" : "N", wt = Ke;
                    wt < Xe;
                    ++wt
                  )
                    x[wt] = Mt;
          ...
          function Do(e, t) {
            ...
            if (n)
              for (var i = void 0, o = 0; o < n.length; ++o)
                (i = n[o]),
                  i.marker.collapsed && (t ? i.from : i.to) == null && (!r || Si(r, i.marker) < 0) && (r = i.marker);
            return r;
          }
          function Mo(e) {
            return Do(e, !0);
...
`
              ...
              if (((e.trailingSpace = a.charCodeAt(t.length - 1) == 32), n || r || i || u || o || l)) {
                ...
                var G = d("span", [h], Q, o);
                if (l)
                  for (var ee in l) l.hasOwnProperty(ee) && ee != "style" && ee != "class" && G.setAttribute(ee, l[ee]);
          ...
          function qr(e, t) {
            var n = f(t),
              r = Ai(e, n);
            r && !r.text ? (r = null) : r && r.changes && (Io(e, r, n, Ii(e)), (e.curOp.forceUpdate = !0)),
              r || (r = ms(e, t));
            var i = Ro(r, t, n);
          ...
          function Ko(e, t, n) {
            for (var r, i, o, l, a, s, u = 0; u < e.length; u += 3)
              if (
                ...
                if (
                  ((r = e[u + 2]), a == s && n == (r.insertLeft ? "left" : "right") && (l = n), n == "left" && i == 0)
                )
              ...
              M = Nt(
                function (me) {
                  ...
                  return (
                    (pe.top += l),
                    (pe.bottom += l),
                    Pi(pe, r, i, !1) ? (pe.top <= i && pe.left <= r && ((k = me), (x = pe)), !0) : !1
                  );
                },
                a,
                s
          ...
          function Ur(e, t) {
            e.state.delayingBlurEvent ||
              (e.state.focused &&
                (Ye(e, "blur", e, t), (e.state.focused = !1), Ee(e.display.wrapper, "CodeMirror-focused")),
            ...
            for (
              ...
              if (!a.hidden) {
                if (((i += a.line.height), b && N < 8)) {
                  ...
                  (u = k.bottom - k.top),
                    !s && a.text.firstChild && (h = a.text.firstChild.getBoundingClientRect().right - k.left - 1);
                }
          ...
          function ji(e, t) {
            t != null &&
              (ei(e), (e.curOp.scrollTop = (e.curOp.scrollTop == null ? e.doc.scrollTop : e.curOp.scrollTop) + t));
          }
          function Gr(e) {
            ei(e);
            var t = e.getCursor();
          ...
          function sl(e) {
            e.display.scrollbars &&
              ...
              e.display.scrollbars.addClass && Ee(e.display.wrapper, e.display.scrollbars.addClass)),
          ...
          function Ns(e) {
            ...
            Ws(t),
              ...
              (e.update =
                e.mustUpdate && new ti(t, e.mustUpdate && { top: e.scrollTop, ensure: e.scrollToPos }, e.forceUpdate));
          }
          function Os(e) {
          ...
          function Rs(e, t, n) {
            ...
            function a(M) {
              var E = M.nextSibling;
              return (
                _ && se && e.display.currentWheelTarget == M ? (M.style.display = "none") : M.parentNode.removeChild(M),
                E
              );
            }
          ...
          function gr(e) {
            return e.text
              ? L(e.from.line + e.text.length - 1, ge(e.text).length + (e.text.length == 1 ? e.from.ch : 0))
              : e.to;
          }
          function gl(e, t) {
          ...
          function kl(e, t, n, r) {
            ...
            if (
              ...
              (a = ge(l.changes)),
                Z(t.from, t.to) == 0 && Z(t.from, a.to) == 0 ? (a.to = gr(t)) : l.changes.push(Vi(e, t));
            else {
              var s = ge(i.done);
              for (
            ...
            for (var r = [], i = 0; i < e.length; ++i) {
              ...
              for (var s = 0; s < l.length; ++s) {
                ...
                if ((a.push({ from: u.from, to: u.to, text: u.text }), t))
                  for (var v in u)
                    (h = v.match(/^spans_(\d+)$/)) && oe(t, Number(h[1])) > -1 && ((ge(a)[v] = u[v]), delete u[v]);
              }
            }
            return r;
          }
          ...
          function li(e, t, n) {
            ...
            Dl(e, Fl(e, t, r, !0)),
              !(n && n.scroll === !1) && e.cm && e.cm.getOption("readOnly") != "nocursor" && Gr(e.cm);
          }
          function Dl(e, t) {
            t.equals(e.sel) ||
              ((e.sel = t),
            ...
            if (o.markedSpans)
              for (var l = 0; l < o.markedSpans.length; ++l) {
                ...
                if (
                  ...
                  return (
                    (r < 0 ? u : h) && (x = Al(e, x, r, x.line == t.line ? o : null)), x ? Zr(e, x, t, r, i) : null
                  );
                }
              }
            return t;
          ...
          function Tn(e, t, n, r) {
            ...
            if (!(t.from.line > e.lastLine())) {
              if (t.from.line < e.first) {
                ...
                Pl(e, i),
                  (t = { from: L(e.first, 0), to: L(t.to.line + i, t.to.ch), text: [ge(t.text)], origin: t.origin });
              }
              var o = e.lastLine();
              t.to.line > o &&
                (t = { from: t.from, to: L(o, ce(e, o).text.length), text: [t.text[0]], origin: t.origin }),
              ...
              if (e && this.collapsed && !e.options.lineWrapping)
                for (var s = 0; s < this.lines.length; ++s) {
                  ...
                  h > e.display.maxLineLength &&
                    ((e.display.maxLine = u), (e.display.maxLineLength = h), (e.display.maxLineChanged = !0));
                }
          ...
          (kt.prototype = F(Dn.prototype, {
            ...
            setValue: at(function (e) {
              ...
              Jr(
                this,
                { from: t, to: L(n, ce(this, n).text.length), text: this.splitLines(e), origin: "setValue", full: !0 },
                !0
              ),
...
`
                ...
                if (r && r.length && window.FileReader && window.File)
                  ...
                  try {
                    ...
                    if (h) {
                      var v;
                      if (
                        (t.state.draggingText && !t.state.draggingText.copy && (v = t.listSelections()),
                        li(t.doc, pr(n, n)),
                        v)
                      )
          ...
          function du(e, t, n, r) {
            ...
            return R != null && !(r > 0 && R == t.text.length) && ((E = M(r > 0 ? 0 : i.length - 1, r, u(R))), E)
              ? E
              : null;
          }
          var Nn = {
...
`,
          ...
          function Vl(e) {
            ...
            if (!(e.target && e.target != t.display.input.getField()) && ((t.curOp.focus = y(Y(t))), !Ze(t, e))) {
              ...
              z &&
                ((io = r ? n : null),
                !r && n == 88 && !_n && (se ? e.metaKey : e.ctrlKey) && t.replaceSelection("", null, "cut")),
                I &&
                  !se &&
                  !r &&
                  n == 46 &&
          ...
          function mu(e) {
            ...
            function n(r) {
              (r.keyCode == 18 || !r.altKey) &&
                (Ee(t, "CodeMirror-crosshair"), dt(document, "keyup", n), dt(document, "mouseover", n));
            }
            ...
            r.addNew
              ? a == -1
                ...
                : u.length > 1 && u[a].empty() && r.unit == "char" && !r.extend
                  ? (pt(o, Kt(e, u.slice(0, a).concat(u.slice(a + 1)), 0), { scroll: !1, origin: "*mouse" }),
                    (s = o.sel))
                  : eo(o, a, l, ct)
            ...
            ve(t.scroller, "touchstart", function (s) {
              ...
              ve(t.scroller, "scroll", function () {
                t.scroller.clientHeight &&
                  (yn(e, t.scroller.scrollTop), Cr(e, t.scroller.scrollLeft, !0), Ye(e, "scroll", e));
              }),
            ...
            (e.prototype = {
              ...
              indentSelection: vt(function (r) {
                for (var i = this.doc.sel.ranges, o = -1, l = 0; l < i.length; l++) {
                  ...
                  if (a.empty())
                    a.head.line > o &&
                      (zn(this, a.head.line, r, !0), (o = a.head.line), l == this.doc.sel.primIndex && Gr(this));
                  else {
                    var s = a.from(),
                      u = a.to(),
                      h = Math.max(o, s.line);
              ...
              addWidget: function (r, i, o, l, a) {
                ...
                (i.style.top = u + "px"),
                  ...
                  a == "right"
                    ...
                    : (a == "left" ? (h = 0) : a == "middle" && (h = (s.sizer.clientWidth - i.offsetWidth) / 2),
                      (i.style.left = h + "px")),
...
`));
            ...
            (je.prototype.pollContent = function () {
              ...
              for (
                var Q = ge(v),
                  G = ge(k),
                  ee = Math.min(Q.length - (v.length == 1 ? x : 0), G.length - (k.length == 1 ? x : 0));
            ...
            (je.prototype.onKeyPress = function (e) {
              e.charCode == 0 ||
                ...
                (e.preventDefault(),
                this.cm.isReadOnly() ||
                  lt(this.cm, so)(this.cm, String.fromCharCode(e.charCode == null ? e.keyCode : e.charCode), 0));
            }),
          ...
          C.defineMode("css", function (fe, H) {
                ...
                return /[,+>*\/]/.test(F)
                  ...
                  : F == "." && T.match(/^-?[_a-z][_a-z0-9-]*/i)
                    ...
                    : /[:;{}\[\]\(\)]/.test(F)
                      ? oe(null, F)
                      : T.match(/^[\w-.]+(?=\()/)
                        ? (/^(url(-prefix)?|domain|regexp)$/i.test(T.current()) && (B.tokenize = Ve),
            ...
            return (
              ...
              (Pe.prop = function (T, B, F) {
                ...
                if (T == "hash" && !/^#([0-9a-fA-F]{3,4}|[0-9a-fA-F]{6}|[0-9a-fA-F]{8})$/.test(B.current()))
                  be += " error";
                else if (T == "word") ge(B);
              ...
              (Pe.interpolation = function (T, B, F) {
                return T == "}"
                  ...
                  : T == "{" || T == ";"
                    ? et(T, B, F)
                    : (T == "word" ? (be = "variable") : T != "variable" && T != "(" && T != ")" && (be = "error"),
                      "interpolation");
              }),
              {
            ...
            function se(d, S) {
              for (var w; ; ) {
                if (
                  !d.context ||
                  ((w = d.context.tagName),
                  !b.contextGrabbers.hasOwnProperty(te(w)) || !b.contextGrabbers[te(w)].hasOwnProperty(te(S)))
                )
                  return;
                ne(d);
              }
            ...
            return {
              ...
              token: function (d, S) {
                ...
                return (
                  (w || ie) &&
                    w != "comment" &&
                    ((O = null), (S.state = S.state(ie || w, d, S)), O && (w = O == "error" ? w + " error" : O)),
                  w
                );
              },
        ...
        (function (C) {
          ...
          C.defineMode("javascript", function (De, I) {
            ...
            function re(f, g) {
              ...
              if (/\d/.test(A))
                return f.match(/^[\d_]*(?:n|(?:\.[\d_]*)?(?:[eE][+\-]?[\d_]+)?)?/), te("number", "number");
              if (A == "/")
                return f.eat("*")
            ...
            function Re(f, g, A) {
              ...
              if (f != ";") {
                ...
                if (f == "regexp")
                  return (
                    (D.state.lastType = D.marked = "operator"), D.stream.backUp(D.stream.pos - D.stream.start - 1), d(L)
                  );
              }
            }
            function Ue(f, g) {
            ...
            function Ft(f, g, A) {
              return (
                (g.tokenize == re &&
                  /^(?:operator|sof|keyword [bcd]|case|new|export|default|spread|[\[{}\(,;:]|=>)$/.test(g.lastType)) ||
    ...
    ka ||
      ...
      (function (Et, zt) {
        (function (C) {
          ...
          function N(ie, O) {
            for (var q in ie)
              for (var z = O[q] || (O[q] = []), X = ie[q], ke = X.length - 1; ke >= 0; ke--) z.unshift(X[ke]);
          }
          function _(ie, O) {
          ...
          C.defineMode("python", function (N, _) {
            ...
            var d = {
              ...
              indent: function (S, w) {
                ...
                var m = V(S),
                  y =
                    m.type == w.charAt(0) || (m.type == "py" && !S.dedent && /^(else:|elif |except |finally:)/.test(w));
      ...
      (function (Et, zt) {
        (function (C) {
          ...
          function K(m) {
            ...
            return (
              (y == ")" || y == "]" || y == "}") && (m.indented = m.context.indented), (m.context = m.context.prev)
            );
          }
          function $(m, y, P) {
            if (
          ...
          C.defineMode("clike", function (m, y) {
            ...
            return {
              ...
              token: function (ae, Se) {
                ...
                if (
                  (ae.sol() &&
                    (he.align == null && (he.align = !1), (Se.indented = ae.indentation()), (Se.startOfLine = !0)),
                  ae.eatSpace())
                )
                ...
                if (
                  (Be == "variable" &&
                    (Se.prevToken == "def" ||
                      (y.typeFirstDefinitions && $(ae, Se, ae.start) && V(Se.context) && ae.match(/^\s*\(/, !1))) &&
                    (Be = "def"),
                  Le.token)
                ) {
            ...
            function (De, I) {
              ...
              function de(p, c) {
                ...
                if (c.indentationDiff === null && ((c.indentationDiff = c.indentation), Te)) {
                  for (c.list = null; be < c.listStack[c.listStack.length - 1]; )
                    c.listStack.pop(),
                      c.listStack.length ? (c.indentation = c.listStack[c.listStack.length - 1]) : (c.list = !1);
              ...
              function D(p, c) {
                ...
                if (j === "[" && c.imageMarker && p.match(/[^\]]*\](\(.*?\)| ?\[.*?\])/, !1))
                  return (
                    (c.imageMarker = !1), (c.imageAltText = !0), I.highlightFormatting && (c.formatting = "image"), H(c)
                  );
                if (j === "]" && c.imageAltText) {
                ...
                if (
                  I.xml &&
                  j === "<" &&
                  p.match(/^(!--|\?|!\[CDATA\[|[a-z][a-z0-9-]*(?:\s+[a-z_:.\-]+(?:\s*=\s*[^>]+)?)*\s*(?:>|$))/i, !1)
                ) {
                ...
                return (
                  j === " " &&
                    (p.match(/^ +$/, !1) ? c.trailingSpace++ : c.trailingSpace && (c.trailingSpaceNewLine = !0)),
                  H(c)
                );
              }
              function J(p, c) {
    ...
    Ea ||
      ...
      (function (Et, zt) {
        (function (C) {
          ...
          function De(N) {
            N.state.placeholder &&
              (N.state.placeholder.parentNode.removeChild(N.state.placeholder), (N.state.placeholder = null));
          }
          function I(N) {
            De(N);
          ...
          function V(N) {
            var _ = N.getWrapperElement(),
              ie = b(N);
            (_.className = _.className.replace(" CodeMirror-empty", "") + (ie ? " CodeMirror-empty" : "")),
              ie ? I(N) : De(N);
          }
          function b(N) {
      ...
      (function (Et, zt) {
        (function (C) {
              ...
              if (X.local)
                if (X.local.end && z.match(X.local.end)) {
                  ...
                  var we = X.local.mode.token(z, X.localState),
                    te;
                  return (
                    X.local.endScan && (te = X.local.endScan.exec(z.current())) && (z.pos = z.start + te.index), we
                  );
                }
          ...
          function N(O, q, z, X) {
            ...
            z.persistent &&
              !ke &&
              (q.persistentStates = { mode: te, spec: z.spec, state: re, next: q.persistentStates }),
              (q.localState = re),
              (q.local = {
                mode: te,
                end: z.end && I(z.end),
          ...
          function ie(O, q) {
            return function (z, X, ke) {
              ...
              if (z.indent == null || z.local || (q.dontIndentStates && _(z.state, q.dontIndentStates) > -1))
                return C.Pass;
          ...
          C.defineMode("yaml", function () {
            ...
            return {
              token: function (K, $) {
                var V = K.peek(),
                  b = $.escaped;
                if ((($.escaped = !1), V == "#" && (K.pos == 0 || /\s/.test(K.string.charAt(K.pos - 1)))))
                ...
                if (($.literal && ($.literal = !1), K.sol())) {
                  if ((($.keyCol = 0), ($.pair = !1), ($.pairStart = !1), K.match("---") || K.match("...")))
                    return "def";
