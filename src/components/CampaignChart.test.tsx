...
describe("CampaignChart", () => {
  ...
  it("wyświetla komunikat gdy wybrana metryka nie istnieje w danych", () => {
    render(<CampaignChart data={mockData} metric="non_existent_metric" metricLabel="Nieistniejąca Metryka" />);
    expect(screen.getByText('Wybrana metryka "Nieistniejąca Metryka" nie jest dostępna w danych.')).toBeInTheDocument();
  });
