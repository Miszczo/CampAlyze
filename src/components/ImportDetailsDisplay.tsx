    ...
    <>
      <Card className="w-full max-w-4xl mx-auto">
        <CardHeader>
          ...
          <CardDescription>
            Detailed information about the imported file.
          </CardDescription>
        </CardHeader>
        <CardContent className="space-y-6">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div className="space-y-1">
              ...
              <Badge variant="outline" className="text-lg">{platformName}</Badge>
            </div>
            <div className="space-y-1">
              <p className="text-sm font-medium text-gray-500">File Size</p>
              <p className="text-lg">{importDetails.file_size ? (importDetails.file_size / 1024).toFixed(2) + ' KB' : 'N/A'}</p>
            </div>
            <div className="space-y-1">
            ...
            <div className="space-y-1">
              ...
              <Badge variant={importDetails.status === 'completed' ? 'success' : importDetails.status === 'failed' ? 'destructive' : 'secondary'} className="text-lg">
          ...
          {importDetails.column_mappings && typeof importDetails.column_mappings === 'object' && Object.keys(importDetails.column_mappings).length > 0 && (
            <div>
